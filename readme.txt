...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\siteannotator on
     Windows, /home/user/dev/siteannotator on Linux) in a file named
     siteannotator@handicap.annotate and copy that file to
